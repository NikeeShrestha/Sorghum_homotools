...
#SBATCH --output=/work/schnablelab/nikees/homotools/SorghumOut/Split10/%x_%a.out
#SBATCH --error=/work/schnablelab/nikees/homotools/SorghumOut/Split10/%x_%a.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=nshrestha5@unl.edu

# export XDG_CACHE_HOME=/tmp/$USER/.cache # suggested by Adam
genelist=/work/schnablelab/nikees/homotools/DataBase/BTX623/BTX73_Split10
